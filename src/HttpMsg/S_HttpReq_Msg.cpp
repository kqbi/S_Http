...
//## class S_HttpReq_Msg
S_HttpReq_Msg::S_HttpReq_Msg(std::string& connectionId, unsigned version, std::string& target, std::string& body, std::uint64_t& contentLength) : S_Http_Msg(connectionId, body), _path("") {
